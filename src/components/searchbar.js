export function SearchBar() {
  ...
  />
  <div class="relative left-[885.5px] top-[-65px] w-[55px] h-[55px] rounded-xl">
  ...
  inputElement.addEventListener("input", (event) => {
    ...
    if (clearButton === null) {
      ...
      xmark.id = "x";
      xmark.className =
        "text-grey relative left-[835px] top-[-115px] w-[25px] h-[25px] text-[30px]";
      xmark.role = "button";
